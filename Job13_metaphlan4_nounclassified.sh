...
export METAPHLAN_OUTPUT_PREV="${OUTPUT_DIR}/Job12_MetaPhlAn4_Illumina_pairedend"
export METAPHLAN_OUTPUT="${OUTPUT_DIR}/Job13_MetaPhlAn4_no_unclassified"
export ILAB_DIR="${STORE_DIR}/ILAB_Dust"
export METAPHLAN_DB="${METAPHLAN_OUTPUT_PREV}/Database"
